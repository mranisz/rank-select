...
void selectBasic_128_4096(const char *fileName, const char *queriesNum) {
	SelectBasic<SELECT_BASIC_STANDARD, 128, 4096> *select = new SelectBasic<SELECT_BASIC_STANDARD, 128, 4096>();
...
void selectBasic_1024_8192(const char *fileName, const char *queriesNum) {
	SelectBasic<SELECT_BASIC_STANDARD, 1024, 8192> *select = new SelectBasic<SELECT_BASIC_STANDARD, 1024, 8192>();
...
void selectBch_128_4096(const char *fileName, const char *queriesNum) {
	SelectBasic<SELECT_BASIC_COMPRESSED_HEADERS, 128, 4096> *select = new SelectBasic<SELECT_BASIC_COMPRESSED_HEADERS, 128, 4096>();
...
void selectBch_1024_8192(const char *fileName, const char *queriesNum) {
	SelectBasic<SELECT_BASIC_COMPRESSED_HEADERS, 1024, 8192> *select = new SelectBasic<SELECT_BASIC_COMPRESSED_HEADERS, 1024, 8192>();
...
void selectMpe1_128_4096(const char *fileName, const char *queriesNum) {
	SelectMPE<SELECT_MPE1, 128, 4096> *select = new SelectMPE<SELECT_MPE1, 128, 4096>();
...
void selectMpe3_128_4096(const char *fileName, const char *queriesNum) {
	SelectMPE<SELECT_MPE3, 128, 4096> *select = new SelectMPE<SELECT_MPE3, 128, 4096>();
