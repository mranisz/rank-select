...
enum RankBasicType {
        RANK_BASIC_STANDARD = 1,
        RANK_BASIC_COMPRESSED_HEADERS = 2
};

template<RankBasicType T> class RankBasic32 {
private:
	void freeMemory() {
...
template<RankBasicType T> class RankBasic64 {
private:
	void freeMemory() {
            if (this->ranks != NULL) delete[] this->ranks;
            if (this->bits != NULL) delete[] this->bits;
	...
	void initialize() {
        ...
        void build_std(unsigned char *text, unsigned long long extendedTextLen, bool *emptyBlock, unsigned long long notEmptyBlocks) {
            this->bitsLen = notEmptyBlocks * (BLOCK_LEN / sizeof(unsigned long long));
            this->bits = new unsigned long long[this->bitsLen + 16];
            this->alignedBits = this->bits;
            while ((unsigned long long)this->alignedBits % 128) ++this->alignedBits;
        ...
        void build_bch(unsigned char *text, unsigned long long extendedTextLen, bool *emptyBlock, unsigned long long notEmptyBlocks) {
            this->bitsLen = notEmptyBlocks * sizeof(unsigned long long);
            this->bits = new unsigned long long[this->bitsLen + 16];
            this->alignedBits = this->bits;
            while ((unsigned long long)this->alignedBits % 128) ++this->alignedBits;
        ...
        unsigned long long getRank_bch(unsigned long long i) {
            ...
            if (rankNumInCL == (SUPERBLOCKLEN - 1)) rank2 = this->pointer2[LONGSINSUPERBLOCK];
            else {
                rank2 = *(this->pointer2);
                switch(rankNumInCL % 4) {
                    case 3:
            ...
            if ((rankDiff & BLOCK_MASK) == 0) return rank + i * (rankDiff >> 9);
            if (rankNumInCL > 0) this->pointer = this->alignedBits + this->pointer2[OFFSETSTARTINSUPERBLOCK] + 8 * __builtin_popcountll(this->pointer2[OFFSETSTARTINSUPERBLOCK + 1] & masks[rankNumInCL]);
            else this->pointer = this->alignedBits + this->pointer2[OFFSETSTARTINSUPERBLOCK];
            switch (i / 64) {
            case 7:
                        rank += __builtin_popcountll(this->pointer[0]);
...
public:
	...
	void save(FILE *outFile) {
            ...
            if (this->ranksLen > 0) fwrite(this->alignedRanks, (size_t)sizeof(unsigned long long), (size_t)this->ranksLen, outFile);
...
public:
	...
	~RankCF32() {
        ...
        void build(unsigned char *text, unsigned int textLen) {
            ...
            this->bitsLen = (this->border - 1) * INT_BLOCK_LEN_WITH_RANK + (extendedTextLen / BLOCK_LEN - (this->border - 1)) * 2 + 16;
...
public:
        ...
        void build(unsigned char *text, unsigned long long textLen) {
            ...
            for (unsigned long long i = 0; i < extendedTextLen; i += BLOCK_LEN) {
                ...
                for (unsigned long long j = 0; j < BLOCK_LEN; ++j) {
                    ...
                    if (i + j < this->textLen) bitsTemp[bitsCounter] += (((unsigned long long)text[i + j]) << (sizeof(unsigned long long) * (sizeof(unsigned long long) - j % sizeof(unsigned long long) - 1)));
            ...
            this->bitsLen = (this->border - 1) * LONG_BLOCK_LEN_WITH_RANK + (extendedTextLen / BLOCK_LEN - (this->border - 1)) * 2 + 8;
            this->bits = new unsigned long long[this->bitsLen + 16];
            this->alignedBits = this->bits;
            while ((unsigned long long)this->alignedBits % 128) ++this->alignedBits;
	...
	void free() {
        ...
        unsigned long long getSize() {
            unsigned long long size = sizeof(this->border) + sizeof(this->blockBorder) + sizeof(this->bitsLen) + sizeof(this->textLen) + sizeof(this->pointer);
            if (this->bitsLen > 0) size += (this->bitsLen + 16) * sizeof(unsigned long long);
            return size;
        }
...
template<RankMPEType T> class RankMPE32 {
private:
	void freeMemory() {
            if (this->ranks != NULL) delete[] this->ranks;
            if (this->bits != NULL) delete[] this->bits;
...
template<RankMPEType T> class RankMPE64 {
private:
	void freeMemory() {
            if (this->ranks != NULL) delete[] this->ranks;
            if (this->bits != NULL) delete[] this->bits;
	...
	void initialize() {
        ...
        unsigned long long getRank_v1(unsigned long long i) {
            ...
            if (rankNumInCL > 0) {
                ...
                switch(rankNumInCL % 4) {
                    case 3:
                        this->pointer = this->alignedBits + this->pointer2[OFFSETSTARTINSUPERBLOCK] + ((offset >> 32) & 0x3FFF);
                    ...
                    case 1:
                        ...
                        break;
                    default:
                        this->pointer = this->alignedBits + this->pointer2[OFFSETSTARTINSUPERBLOCK] + ((offset >> 48) & 0x3FFF);
        ...
        unsigned long long getRank_v2(unsigned long long i) {
            ...
            if (rankNumInCL > 0) {
                ...
                switch(rankNumInCL % 4) {
                    case 3:
                        this->pointer = this->alignedBits + this->pointer2[OFFSETSTARTINSUPERBLOCK] + ((offset >> 32) & 0x0FFF);
                    ...
                    case 1:
                        ...
                        break;
                    default:
                        this->pointer = this->alignedBits + this->pointer2[OFFSETSTARTINSUPERBLOCK] + ((offset >> 48) & 0x0FFF);
